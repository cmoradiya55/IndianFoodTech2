...
import PeanutButterExportToArgentina from "./PeanutButterExportToArgentina";

export const metadata: Metadata = {
  title: "Peanut Butter Exporter to Argentina | Bulk Supply India",
  description:
    "Reliable peanut butter exporter to Argentina. Indian Foodtech offers premium bulk supply, private label, and industrial solutions for the Argentine market.",
  keywords: [
    "peanut butter exporter to argentina",
    "exportador a mantequilla mani argentina",
    "bulk peanut butter buenos aires",
    "private label peanut butter argentina",
    "peanut butter supplier rosario",
    "argentine food exporters to",
    ...
    "export peanut butter to Argentina",
  ...
  openGraph: {
    ...
    url: "https://www.indianfoodtech.com/peanut-butter-export-to-argentina",
    siteName: "Indian Foodtech",
    type: "website",
    locale: "es_AR",
  },
  alternates: {
    canonical: "https://www.indianfoodtech.com/peanut-butter-export-to-argentina",
    languages: {
      "es-AR": "https://www.indianfoodtech.com/peanut-butter-export-to-argentina",
  ...
  return (
    <>
      <MarketSchema
        country="Argentina"
        type="Exporter"
        description="Reliable peanut butter exporter to Argentina. Indian Foodtech offers premium bulk supply, private label, and industrial solutions for the Argentine market."
        url="https://www.indianfoodtech.com/peanut-butter-export-to-argentina"
      />
      <PeanutButterExportToArgentina />
    </>
  );
}
