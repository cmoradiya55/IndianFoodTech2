...
const PeanutButterExportToFrance = () => {
            ...
            >
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-gray-950 leading-[1.1] tracking-tighter">
                ...
                <span className="text-primary-500 font-black">
                  Exportateur de beurre de cacahuète en France
                </span>
              </h1>
      ...
      <section className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 border-b border-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row gap-6 items-center">
            ...
            >
              <h3 className="text-xl font-semibold mb-4">France Quick-Ship</h3>
        ...
        >
          <div className="relative z-10 flex flex-col items-center space-y-4">
            ...
            <h2 className="text-xl sm:text-2xl font-black text-gray-900 leading-tight mt-4">
              ...
              <span className="text-primary-500">in France</span>
            </h2>
...
export default PeanutButterExportToFrance;
