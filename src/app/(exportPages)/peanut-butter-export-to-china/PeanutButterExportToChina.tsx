...
const PeanutButterExportToChina = () => {
              ...
              <div className="relative group">
                ...
                <div className="relative bg-white rounded-[2rem] shadow-strong p-2 overflow-hidden border border-gray-100">
                  <div className="relative aspect-[16/10] bg-primary-50 rounded-[1.8rem] flex items-center justify-center overflow-hidden">
                    <Image
                      src="/country/import-china.webp"
                      alt="Peanut butter exporter from India to China bulk supply Shanghai"
                      fill
          ...
          >
            {[
              ...
              },
              {
                ...
                desc: "Selection of best sea and air routes for China.",
...
export default PeanutButterExportToChina;
