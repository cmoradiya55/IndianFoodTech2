...
import PeanutButterExportToGreece from "./PeanutButterExportToGreece";
import MarketSchema from "@/components/MarketSchema";

export const metadata: Metadata = {
  title: "Peanut Butter Exporter to Greece | Bulk Export from India",
  description:
    "Reliable peanut butter exporter to Greece. Indian Foodtech offers premium bulk supply, private label, and industrial solutions for the Greek market.",
  keywords: [
    "peanut butter exporter to greece",
    "bulk peanut butter greece",
    "private label peanut butter greece",
    "peanut butter supplier athens",
    "greek food exporters to",
    ...
    "export peanut butter to Greece",
  ...
  openGraph: {
    ...
    url: "https://www.indianfoodtech.com/peanut-butter-export-to-greece",
    siteName: "Indian Foodtech",
    type: "website",
    locale: "en_GR",
  },
  alternates: {
    canonical: "https://www.indianfoodtech.com/peanut-butter-export-to-greece",
    languages: {
      "en-GR": "https://www.indianfoodtech.com/peanut-butter-export-to-greece",
  ...
  return (
    <>
      <MarketSchema
        country="Greece"
        type="Exporter"
        description="Reliable peanut butter exporter to Greece. Indian Foodtech provides high-quality bulk supply and private label services for the Greek market."
        url="https://www.indianfoodtech.com/peanut-butter-export-to-greece"
      />
      <PeanutButterExportToGreece />
    </>
  );
}
