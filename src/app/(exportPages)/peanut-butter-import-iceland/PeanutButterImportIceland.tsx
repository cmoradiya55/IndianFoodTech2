      ...
      <section className="py-6 px-4 sm:px-6 lg:px-8 bg-white text-center">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-sm text-gray-600 max-w-3xl mx-auto leading-relaxed">
            As a leading{" "}
            <strong>peanut butter exporter from India to Iceland</strong>, we
            specialize in delivering premium, nutrient-dense nut butters.
            Whether you are a distributor in
            <strong> Reykjavik</strong>, <strong>Akureyri</strong>, or a
            retailer in
            <strong> Hafnarfjorður</strong>, our bulk supply and private label
            solutions are perfectly suited for the Icelandic market.
          </p>
        </div>
      </section>
