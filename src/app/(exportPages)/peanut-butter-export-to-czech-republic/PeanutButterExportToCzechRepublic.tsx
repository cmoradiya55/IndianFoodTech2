...
const PeanutButterExportToCzechRepublic = () => {
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center">
            ...
            >
              ...
              <p className="text-sm pr-24 opacity-80 font-medium leading-relaxed max-w-2xl mx-auto lg:mx-0" style={{ fontFamily: "Poppins-medium" }}>
                Launch your own premium peanut butter brand in Czech Republic with
...
export default PeanutButterExportToCzechRepublic;
