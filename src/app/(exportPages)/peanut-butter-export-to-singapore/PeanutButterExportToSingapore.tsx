...
const PeanutButterExportToSingapore = () => {
      ...
      <section className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 border-b border-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row gap-6 items-center">
            ...
            >
              <h3 className="text-xl font-semibold mb-4">Singapore Quick-Ship</h3>
              ...
              >
                {[
                  ...
                  },
                  {
                    ...
                    desc: "Logistics experts to handle Singapore import documentation and shipping.",
                  },
                ].map((item, idx) => (
                  <motion.div
                    variants={itemVariants}
        ...
        >
          <div className="relative z-10 flex flex-col items-center space-y-4">
            ...
            <h2 className="text-xl sm:text-2xl font-black text-gray-900 leading-tight mt-4">
              ...
              <span className="text-primary-500">in Singapore</span>
            </h2>
...
export default PeanutButterExportToSingapore;
