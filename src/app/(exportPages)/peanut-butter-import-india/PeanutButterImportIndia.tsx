                ...
                <div className="relative bg-white rounded-[2rem] shadow-strong p-2 overflow-hidden border border-gray-100">
                  <div className="relative aspect-[16/10] bg-primary-50 rounded-[1.8rem] flex items-center justify-center overflow-hidden">
                    <Image
                      ...
                      alt="Peanut butter exporter in India bulk supply Mumbai"
                      fill
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row gap-6 items-center">
            ...
            <div className="md:w-1/3 bg-primary-600 rounded-3xl p-8 sm:px-10 sm:py-8 text-white shadow-xl">
              <h3 className="text-xl font-black mb-4">India Quick-Ship</h3>
            ...
            <div className="space-y-6 order-2 lg:order-1">
              ...
              <div className="space-y-5">
                {[
                  ...
                  {
                    title: "Bespoke Quality Standards",
                  ...
                  {
                    title: "Dedicated National Team",
                    desc: "Logistics experts to handle Indian supply documentation and distribution.",
                  },
                ].map((item, idx) => (
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10 space-y-2">
            ...
            <p className="text-gray-600 font-medium">
              Streamlined logistics for Indian importers
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
            {[
              {
                title: "Documentation",
                desc: "Precise execution of all domestic and regulatory documents.",
                icon: <Star className="w-7 h-7" />,
              },
              {
                title: "Secure Packing",
                desc: "High-grade packaging to withstand national transit.",
                icon: <Package className="w-7 h-7" />,
              },
              {
                title: "Transit Options",
                desc: "Selection of best road and rail routes within India.",
                icon: <Truck className="w-7 h-7" />,
              },
              {
                title: "Local Support",
                desc: "On-ground support for wholesale and retail supply.",
                icon: <ShieldCheck className="w-7 h-7" />,
              },
            ].map((step, idx) => (
