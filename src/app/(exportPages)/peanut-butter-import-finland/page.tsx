...
export const metadata: Metadata = {
  title: "Peanut Butter Importer Finland | Bulk Export from India",
  description:
    "Reliable peanut butter importer in Finland. Indian Foodtech offers premium bulk supply, private label, and industrial solutions for the Finnish market.",
  keywords: [
  ...
  openGraph: {
    ...
    url: "https://www.indianfoodtech.com/peanut-butter-import-finland",
    siteName: "Indian Foodtech",
    type: "website",
    locale: "en_FI",
  },
  alternates: {
    canonical: "https://www.indianfoodtech.com/peanut-butter-import-finland",
    languages: {
      "en-FI": "https://www.indianfoodtech.com/peanut-butter-import-finland",
