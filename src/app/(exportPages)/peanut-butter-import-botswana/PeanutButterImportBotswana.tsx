...
const PeanutButterImportBotswana = () => {
  return (
              ...
              <div className="relative group">
                ...
                <div className="relative bg-white rounded-[2rem] shadow-strong p-2 overflow-hidden border border-gray-100">
                  <div className="relative aspect-[16/10] bg-primary-50 rounded-[1.8rem] flex items-center justify-center overflow-hidden">
                    <Image
                      src="/country/import-botswana.webp"
                      alt="Peanut butter exporter from India to Botswana bulk supply Gaborone"
                      fill
          ...
          <div className="flex flex-col md:flex-row gap-6 items-center">
            <div className="flex-1">
              <h2 className="text-lg sm:text-2xl font-black text-gray-900 mb-4 flex items-center gap-3">
                ...
                Exporting Peanut Butter to Botswana
              </h2>
              <p className="text-base text-gray-600 leading-relaxed mb-6 font-medium">
                We have extensive experience in the Southern African markets,
                specifically understanding the detailed requirements of
                importers in Botswana. Our operations are streamlined to ensure
            ...
            <div className="md:w-1/3 bg-primary-600 rounded-3xl p-8 sm:px-10 sm:py-8 text-white shadow-xl">
              <h3 className="text-xl font-black mb-4">Botswana Quick-Ship</h3>
              ...
              <div className="space-y-5">
                {[
                  ...
                  },
                  {
                    ...
                    desc: "Logistics experts to handle Botswana import documentation and shipping.",
                  },
                ].map((item, idx) => (
              ...
              <div className="bg-[#1D2C00] rounded-[2.5rem] p-12 text-white relative overflow-hidden">
                ...
                <div className="absolute top-0 right-0 w-full h-full opacity-5 pointer-events-none">
                  <svg width="100%" height="100%" viewBox="0 0 100 100" fill="none">
                    <circle cx="90" cy="10" r="40" stroke="white" strokeWidth="1" />
                    <circle cx="10" cy="90" r="40" stroke="white" strokeWidth="1" />
                  </svg>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center">
            <div className="lg:w-1/2 space-y-6 text-center lg:text-left">
              <h2 className="text-xl sm:text-2xl lg:text-3xl pr-34 font-black leading-[1.1]">
                ...
                <span className="text-primary-400">in Botswana</span>
              </h2>
              <p className="text-base pr-24 opacity-80 font-medium leading-relaxed max-w-2xl mx-auto lg:mx-0">
                Launch your own premium peanut butter brand in Botswana with our
                end-to-end OEM services. We provide the quality; you provide the
                vision.
              </p>
              <div className="flex flex-wrap gap-4 justify-center lg:justify-start pt-2">
                {["Custom Packaging", "Logo Design", "Bulk Supply", "Market Ready"].map(
                  (tag, idx) => (
                    <span
                      key={idx}
            ...
            <div className="lg:w-1/2 w-full">
              <div className="grid grid-cols-2 gap-4">
                {[
                  { icon: <Star className="w-8 h-8" />, label: "Premium Recipe" },
                  { icon: <Settings2 className="w-8 h-8" />, label: "Custom Textures" },
                  { icon: <ShieldCheck className="w-8 h-8" />, label: "Safety First" },
                  { icon: <Package className="w-8 h-8" />, label: "Durable Jars" },
                ].map((card, idx) => (
                  <div
                    key={idx}
                  ...
                  >
                    <div className="text-primary-400 mb-4 inline-block">{card.icon}</div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10 space-y-2">
            ...
            <p className="text-gray-600 font-medium">
              Streamlined logistics for Botswana importers
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
            {[
              ...
              },
              {
                ...
                desc: "Selection of best sea and air routes for Botswana.",
...
export default PeanutButterImportBotswana;
