...
const PeanutButterExportToSouthKorea = () => {
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-center text-center lg:text-left">
            ...
            >
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-gray-950 leading-[1.1] tracking-tighter">
                Peanut Butter Exporter to South Korea
                <br />
      ...
      <section className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 border-b border-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row gap-6 items-center">
            ...
            >
              <h3 className="text-xl font-semibold mb-4">South Korea Quick-Ship</h3>
              ...
              >
                {[
                  ...
                  },
                  {
                    ...
                    desc: "Logistics experts to handle South Korea import documentation and shipping.",
                  },
                ].map((item, idx) => (
                  <motion.div
                    variants={itemVariants}
        ...
        >
          <div className="relative z-10 flex flex-col items-center space-y-4">
            ...
            <h2 className="text-xl sm:text-2xl font-black text-gray-900 leading-tight mt-4">
              ...
              <span className="text-primary-500">in South Korea</span>
            </h2>
...
export default PeanutButterExportToSouthKorea;
