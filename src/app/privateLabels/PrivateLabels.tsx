      ...
      >
        ...
        <div>
          ...
          <div className="block lg:hidden">
            <div className="bg-white p-4 sm:p-6 md:p-8 mt-6 sm:mt-8 rounded-2xl sm:rounded-3xl shadow-lg">
              {/* Image Section */}
              ...
              <div className="flex flex-col text-center">
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-2xl font-medium text-black mb-2.5 sm:mb-3">
                  About Private Label
                </h2>
                <p
