  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-900 overflow-x-hidden">
          ...
          <div className="flex flex-col lg:flex-row gap-6 items-center text-center lg:text-left">
            <div className="flex-1 space-y-6 sm:space-y-6 animate-slide-up">
              ...
              <h1 className="text-xl sm:text-lg lg:text-3xl font-black text-gray-900 leading-[1.1] tracking-tight">
                ...
                <span className="text-primary-600">in USA</span>
              </h1>
              <p className="text-base text-gray-600 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium">
                ...
                from India to distributors and brands across the United States.
              </p>
                ...
                <div className="relative bg-primary-600/50 rounded-3xl shadow-strong p-2 overflow-hidden border border-gray-100">
                  <div className="relative aspect-[4/3] bg-[#f0f4ea] rounded-2xl flex items-center justify-center overflow-hidden">
                    <Image
                      ...
                      alt="Export Peanut Butter to USA"
                      fill
          ...
          <div className="flex flex-col md:flex-row gap-6 items-center">
            <div className="flex-1">
              <h2 className="text-lg sm:text-2xl font-black text-gray-900 mb-4 flex items-center gap-3">
                ...
                Exporting Peanut Butter to USA
              </h2>
              <p className="text-base text-gray-600 leading-relaxed mb-6 font-medium">
                We have extensive experience in the North American market,
                specifically understanding the detailed requirements of
                importers in the United States. Our operations are streamlined to
                ensure your orders arrive fresh, on time, and fully FDA
                compliant.
              </p>
            ...
            <div className="md:w-1/3 bg-primary-600 rounded-3xl p-8 sm:px-10 sm:py-8 text-white shadow-xl">
              ...
              <ul className="space-y-3 font-medium opacity-90">
                ...
                <li className="flex gap-3">
                  ...
                  Trans-Pacific Optimized Routes
                </li>
                <li className="flex gap-3">
                  <span className="font-black text-primary-200">03</span>
                  US Customs & FDA Support
                </li>
              </ul>
            </div>
          </div>
              ...
              <div className="space-y-5">
                {[
                  ...
                  },
                  {
                    ...
                    desc: "Rigorous quality control adhering to international safety certifications including FDA compliance.",
                  },
                  {
                  ...
                  },
                  {
                    ...
                    desc: "Logistics experts to handle US import documentation and shipping.",
                  },
                ].map((item, idx) => (
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center">
            <div className="lg:w-1/2 space-y-6 text-center lg:text-left">
              <h2 className="text-xl sm:text-2xl lg:text-3xl pr-34 font-black leading-[1.1]">
                ...
                <span className="text-primary-400">in USA</span>
              </h2>
              <p className="text-base pr-24 opacity-80 font-medium leading-relaxed max-w-2xl mx-auto lg:mx-0">
                Launch your own premium peanut butter brand in the United States
                with our end-to-end OEM services. We provide the quality; you
                provide the vision.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10 space-y-2">
            ...
            <p className="text-gray-600 font-medium">
              Streamlined logistics for US importers
            </p>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
              {[
                {
                  title: "Documentation",
                  desc: "Precise execution of Invoice, Packing List, COO, and FDA Prior Notice.",
                  icon: <Star className="w-7 h-7" />,
                },
                {
                  title: "Secure Packing",
                  desc: "Export-grade packaging to withstand trans-oceanic transit.",
                  icon: <Package className="w-7 h-7" />,
                },
                {
                  title: "Shipping Options",
                  desc: "Selection of best sea and air routes for the United States.",
                  icon: <Truck className="w-7 h-7" />,
                },
                {
                  title: "Local Support",
                  desc: "Advisory support for US customs and FDA import clearance.",
                  icon: <ShieldCheck className="w-7 h-7" />,
                },
              ].map((step, idx) => (
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-[3rem] p-12 sm:p-16 text-center shadow-strong border border-primary-100 relative overflow-hidden mb-10">
          ...
          <div className="relative z-10 flex flex-col items-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
              ...
              <Link
                href="/contactUs"
                className="inline-flex items-center justify-center gap-2 border-2 border-primary-500 hover:bg-primary-50 text-primary-600 px-10 py-2 rounded-full text-base font-semibold transition-all"
              >
                Send Inquiry
              </Link>
            </div>
      ...
      <div className="fixed bottom-6 right-6 z-50 sm:hidden">
        <Link
          href="https://wa.me/919714899711"
          className="w-16 h-16 bg-green-500 rounded-full flex items-center justify-center text-white shadow-2xl animate-pulse"
        >
...
export default PeanutButterSupplierUsa;
