  ...
  return lines.map((line, index) => {
    ...
    if (line.includes("**")) {
      ...
      return (
        <p
          key={index}
          className="text-gray-700 text-base sm:text-lg leading-[1.8] mb-6"
        >
          {parts.map((part, i) =>
            i % 2 === 1 ? (
              <strong
                key={i}
                className="font-extrabold text-gray-950 underline decoration-primary-100 decoration-2 underline-offset-4"
              >
                {part}
              </strong>
            ) : (
            ...
            <div className="relative z-10 text-center sm:text-left flex flex-col sm:flex-row items-center gap-8">
              <div className="flex-1">
                ...
                <p className="text-gray-400 text-sm font-medium">
                  Fresh market trends and manufacturing insights delivered
                  monthly.
                </p>
              </div>
