...
const PeanutButterImportCzechRepublic = () => {
  return (
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-center text-center lg:text-left">
            <div className="flex-1 space-y-5 animate-slide-up">
              ...
              <p className="text-base sm:text-lg text-gray-600 max-w-xl mx-auto lg:mx-0 leading-relaxed font-medium">
                Indian Foodtech is your trusted manufacturing partner supplying
                premium peanut butter to distributors and brands across Czech
                Republic.
                <br />
                <span className="block mt-2 text-gray-500">
                  Hledáte spolehlivého dodavatele arašídového másla v České
                  republice? Dodáváme kvalitní arašídové máslo pro velkoobchod a
                  privátní značky.
                </span>
              </p>
              ...
              <div className="relative group">
                ...
                <div className="relative bg-white rounded-[2rem] shadow-strong p-2 overflow-hidden border border-gray-100">
                  <div className="relative aspect-[16/10] bg-primary-50 rounded-[1.8rem] flex items-center justify-center overflow-hidden">
                    <Image
                      src="/country/import-czech-republic.webp"
                      alt="Peanut butter exporter from India to Czech Republic bulk supply Prague"
                      fill
          ...
          <div className="flex flex-col md:flex-row gap-6 items-center">
            <div className="flex-1">
              <h2 className="text-lg sm:text-2xl font-black text-gray-900 mb-4 flex items-center gap-3">
                ...
                Exporting Peanut Butter to Czech Republic
              </h2>
              <p className="text-base text-gray-600 leading-relaxed mb-6 font-medium">
                ...
                importers in Czech Republic. Our operations are streamlined to
                ensure your orders arrive fresh and on time.
              </p>
              ...
              <div className="space-y-5">
                {[
                  ...
                  },
                  {
                    ...
                    desc: "Logistics experts to handle Czech Republic import documentation and shipping.",
                  },
                ].map((item, idx) => (
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center">
            <div className="lg:w-1/2 space-y-6 text-center lg:text-left">
              <h2 className="text-xl sm:text-2xl lg:text-3xl pr-34 font-black leading-[1.1]">
                ...
                <span className="text-primary-400">in Czech Republic</span>
              </h2>
              <p className="text-base pr-24 opacity-80 font-medium leading-relaxed max-w-2xl mx-auto lg:mx-0">
                Launch your own premium peanut butter brand in Czech Republic
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10 space-y-2">
            ...
            <p className="text-gray-600 font-medium">
              Streamlined logistics for Czech Republic importers
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
              {[
                ...
                },
                {
                  ...
                  desc: "Selection of best sea and air routes for Czech Republic.",
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-[3rem] p-12 sm:p-16 text-center shadow-strong border border-primary-100 relative overflow-hidden mb-10">
          ...
          <div className="relative z-10 flex flex-col items-center space-y-4">
            ...
            <h2 className="text-xl sm:text-2xl font-black text-gray-900 leading-tight px-12">
              Ready to Import to Czech Republic?
            </h2>
...
export default PeanutButterImportCzechRepublic;
