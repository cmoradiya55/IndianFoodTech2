      ...
      >
            ...
            <div className="mb-3">
              <div className="bg-[#EDEDED] border border-[#D2D1D6] rounded-lg p-3">
                ...
                <div className="flex items-center mb-3">
                  <h2 className="text-[10px] sm:text-[11px] md:text-[12px] font-semibold text-[#00280C] bg-[#D4DBC4] rounded-lg px-3 py-1">
                ...
                <div className="bg-white rounded-lg p-3 shadow-sm">
                  <div className="grid grid-cols-2 gap-3">
                    {product.nutrition.includes("Calories") && (
                      <div className="text-center">
                        <div className="text-[13px] md:text-[14px] font-bold text-primary-500">
                  ...
                  <div className="mt-3 pt-3 border-t border-gray-200">
                    <p
                      className="text-black font-medium text-center text-[11px] md:text-[12px]"
                      style={{ fontFamily: "Inter_18pt-medium" }}
                    >
                      {product.nutrition}
                    </p>
                ...
                <div className="bg-[#EDEDED] border border-[#D2D1D6] rounded-lg p-3">
                  <div className="flex flex-col sm:flex-row items-start gap-3">
                    <div className="bg-[#D4DBC4] rounded-lg px-3 py-1 flex-shrink-0">
                      <h2 className="text-[11px] md:text-[12px] font-semibold text-[#00280C]">
                        Available Sizes
                      </h2>
                    </div>
                    <div className="flex-1">
                      <div className="grid grid-cols-2 sm:grid-cols-3 gap-1">
                        {product.sizes.map((size, index) => (
                          <div
                            key={index}
                            className="text-black font-semibold text-[11px] md:text-[12px]"
                            style={{ fontFamily: "Inter_18pt-medium" }}
                          >
                            {size}
                          </div>
                    ...
                    <div className="flex-1">
                      <div className="space-y-1">
                        {product.certifications.map((cert, index) => (
                          <div
                            key={index}
                            className="text-primary-500 font-semibold text-[11px] md:text-[12px]"
                            style={{ fontFamily: "Inter_18pt-medium" }}
                          >
                            {cert}
                          </div>
            ...
            >
              <div className="gap-3 sm:gap-4 flex flex-col items-center justify-center">
                ...
                <div className="flex-1 text-center mt-1 sm:mt-2">
                  ...
                  <div
                    className="text-gray-800 text-[10px] sm:text-xs font-medium leading-relaxed"
                    style={{ fontFamily: "Inter_18pt-medium" }}
                  >
                    {stat.description}
                  </div>
        ...
        <div>
          ...
          <div className="flex items-center justify-center mb-4 sm:mb-6 md:mb-8">
            <div
              className="bg-[#1D2C00] text-white mt-6 sm:mt-8 md:mt-2 px-6 sm:px-12 md:px-12 lg:px-25 py-2 sm:py-3 md:py-3 lg:py-2 rounded-full text-xs sm:text-base md:text-base lg:text-base font-normal text-center"
