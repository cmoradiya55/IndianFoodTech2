...
export const AllProductsList = [
  {
    ...
    products: [
      ...
      },
      {
        ...
        otherImages: ["/productsImage/Natural Crunch Peanut Butter.webp"],
      },
      {
        id: "C1P3",
        name: "Classic Creamy Peanut Butter",
        description:
          "Rich, creamy & crunchy classic peanut butter. Perfect for sandwiches, smoothies & healthy snacking. Protein-packed goodness.",
        detailedDescription:
          "Experience the classic goodness of our Creamy Peanut Butter, crafted from 100% premium roasted peanuts—nothing more, nothing less. Free from added sugar, preservatives, and hydrogenated oils, it’s pure, natural, and packed with nutrition. With its velvety-smooth texture, it spreads effortlessly on bread, stirs seamlessly into smoothies, and adds rich flavor to baking or savory dishes. Every bite delivers authentic peanut taste while providing a powerful boost of plant-based protein, fiber, and healthy fats. Whether you’re fueling your fitness goals, managing your diet, or simply indulging in a wholesome treat, our Classic Creamy Peanut Butter is the perfect balance of nutrition and flavor.",
        ingredients:
          "Roasted Peanut, Sugar, Salt, Stabilizer (to  prevent oil sepration).",
        nutrition:
          "Per 2 tbsp (32g): Calories 190kcal, Fat 13g, Carbs 9g, Protein 8g",
        certifications: certificatList,
        sizes: packingSizes,
        recommended: false,
        cardImage: "/productsImage/Classic Creamy Peanut Butter.webp",
        otherImages: ["/productsImage/Classic Creamy Peanut Butter.webp"],
      },
      {
        id: "C1P4",
        ...
        otherImages: ["/productsImage/Classic Crunch Peanut Butter.webp"],
      },
      {
        id: "C1P5",
      ...
      },
      {
        ...
        otherImages: ["/productsImage/Cardamom Creamy Peanut Butter.webp"],
      },
      {
        id: "C1P8",
        ...
        otherImages: ["/productsImage/Cardamom Crunch Peanut Butter.webp"],
      },
      // {
      //     id: "C1P9",
      ...
      // },
      {
        ...
        sizes: packingSizes,
        recommended: false,
        cardImage: "/productsImage/Sugar Free Creamy Peanut Butter.webp",
        otherImages: ["/productsImage/Sugar Free Creamy Peanut Butter.webp"],
      },
      {
        id: "C1P13",
        ...
        sizes: packingSizes,
        recommended: false,
        cardImage: "/productsImage/Sugar Free Crunchy Peanut Butter.webp",
        otherImages: ["/productsImage/Sugar Free Crunchy Peanut Butter.webp"],
      },
    ],
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        name: "Cashew Butter",
        description:
          "Smooth, creamy cashew butter made from 100% roasted premium cashews. Naturally rich in protein, magnesium & healthy fats.",
        detailedDescription:
        ...
        nutrition:
          "Per 2 tbsp (32g): Calories 186kcal, Fat 15g, Carbs 9g, Protein 6g",
        certifications: certificatList,
        sizes: packingSizes,
        cardImage: "/productsImage/Cashew Butter.webp",
        recommended: false,
      },
      {
        id: "C2P3",
  ...
  },
  {
    ...
    products: [
      ...
      // },
      {
        ...
        description:
          "Premium roasted peanut dices with uniform size & rich crunch. Ideal for bakery, confectionery, snacks & toppings",
        detailedDescription:
          "Our crunchy organic peanut butter features finely chopped peanut pieces for that satisfying texture everyone loves. Made from premium organic peanuts with just a touch of sea salt to enhance the natural peanut flavor.",
        ingredients:
          "Organic peanuts, organic palm fruit oil (for stability), sea salt.",
        nutrition:
          "Per 2 tbsp (32g): Calories 200, Fat 17g, Carbs 7g, Protein 9g",
        certifications: ["USDA Organic", "Non-GMO Project Verified"],
