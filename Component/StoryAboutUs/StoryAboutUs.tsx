  ...
  return (
    <div className="pb-15">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-8 sm:gap-12 lg:gap-16 mt-8 sm:mt-16 lg:mt-30 max-w-7xl mx-auto relative">
        ...
        {/* Right Side - Content */}
        <div className="flex-1 bg-white w-full lg:w-[568px] lg:absolute lg:right-25 rounded-2xl sm:rounded-3xl shadow-lg p-4 sm:p-6 md:p-8 lg:p-10 z-20 mt-6 lg:mt-0">
          {/* Introduction Text */}
          <p
            className="text-gray-800 text-xs sm:text-sm md:text-md lg:text-lg mb-2 sm:mb-3 leading-relaxed"
            style={{ fontFamily: "Inter_18pt-medium" }}
          >
          ...
          <div className="mb-2 sm:mb-4">
            <h2 className="text-xl sm:text-2xl md:text-[26px] lg:text-2xl font-bold text-primary-500 mb-1">
              Peanut Butter Your Way
            </h2>
            <p
