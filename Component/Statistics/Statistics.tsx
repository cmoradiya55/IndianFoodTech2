    ...
    <div>
      ...
      <div className="mb-4 sm:mb-4 md:mb-6 lg:mb-8 flex gap-3 sm:gap-4 lg:gap-5">
        ...
        <div className="mt-1 sm:mt-1 lg:mt-2">
          <h1 className="text-lg sm:text-lg md:text-xl lg:text-2xl font-bold text-gray-900 mb-2 leading-tight">
            Spreading Health and Happiness
            <br />
            Since 2019
          </h1>
          <p
            className="text-base sm:text-md md:text-base lg:text-lg text-primary-500 font-medium leading-relaxed"
        ...
        {stats.map((stat, index) => (
          ...
          >
            <div className="flex items-start gap-3 sm:gap-4 lg:gap-5">
              {/* Green Circle Icon */}
              <div className="w-14 h-14 sm:w-16 sm:h-16 md:w-[50px] md:h-[50px] lg:w-[60px] lg:h-[60px] bg-gradient-to-b from-primary-400 to-primary-600 rounded-xl sm:rounded-2xl lg:rounded-2xl flex-shrink-0 shadow-md flex items-center justify-center">
                {stat.icon}
              </div>

              {/* Text Content */}
              <div className="flex-1">
                <div className="text-base sm:text-lg md:text-lg lg:text-xl font-bold text-gray-900 mb-1">
                  {stat.title}
                </div>
                <div className="text-gray-800 text-sm sm:text-base md:text-lg lg:text-base font-medium">
                  {stat.subtitle}
                </div>
              </div>
            </div>
