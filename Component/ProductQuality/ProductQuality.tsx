    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mb-8 sm:mb-10 md:mb-6 flex gap-3 sm:gap-4">
        ...
        <div className="mt-1 sm:mt-2">
          <h1 className="text-base sm:text-base md:text-lg lg:text-base font-bold text-gray-900 mb-2 sm:mb-3">
            Why We Stand Out
          </h1>
          <p
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 md:gap-6">
        {qualityFeatures.map((feature, index) => {
          return (
            <div
              key={index}
              className="bg-white rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-5 shadow-sm border border-[#D2D1D6] hover:shadow-md transition-shadow duration-300"
            >
              <div className="flex items-start gap-3 sm:gap-4 md:gap-6">
                ...
                <div className="flex-1 pt-0 sm:pt-1">
                  <h3 className="text-base sm:text-lg md:text-lg font-bold text-gray-900">
                    {feature.title}
                  </h3>
                  <p
      ...
      <div className="mt-8 sm:mt-10 md:mt-6 bg-[#00280C] px-4 sm:px-6 md:px-20 py-4 sm:py-5 md:py-4 rounded-2xl sm:rounded-3xl md:rounded-[40px] flex flex-col gap-4 sm:gap-6 md:gap-4 text-center items-center">
        <h2 className="text-base sm:text-lg md:text-lg font-bold text-primary-500">
          Quality Assurance
        </h2>
        <p
