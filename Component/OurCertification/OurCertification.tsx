...
const OurCertification = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-4">
        {certificates.map((cert) => (
          ...
          >
            <div className="relative h-[250px] sm:h-[280px] md:h-[300px] rounded-lg sm:rounded-xl overflow-hidden shadow-lg border-2 sm:border-4 md:border-6 border-primary-500 bg-primary-50 p-1 sm:p-1.5 md:p-2">
              ...
              {/* Overlay caption */}
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-primary-900/90 to-primary-500/10 p-1.5 sm:p-2 md:p-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <p className="text-white font-semibold text-center text-xs sm:text-sm">
                  {cert.title}
                </p>
              </div>
            </div>
        ...
        >
          <div className="w-full max-h-[90vh] sm:max-h-[90vh] rounded-lg sm:rounded-xl overflow-hidden shadow-2xl relative">
            ...
            <div className="absolute top-3 sm:top-5 left-3 sm:left-5 z-20 flex flex-col gap-1 sm:gap-2">
              <button
                className="bg-white/90 hover:bg-white text-black rounded-full w-5 sm:w-6 h-5 sm:h-6 flex items-center justify-center shadow-md transition-all duration-200 hover:shadow-xl text-xs sm:text-base"
                onClick={(e) => {
                  e.stopPropagation();
                  handleZoomIn();
                }}
              ...
              <button
                className="bg-white/90 hover:bg-white text-black rounded-full w-5 sm:w-6 h-5 sm:h-6 flex items-center justify-center shadow-lg transition-all duration-200 hover:shadow-xl text-xs sm:text-base"
                onClick={(e) => {
                  e.stopPropagation();
                  handleZoomOut();
                }}
              ...
              <button
                className="bg-white/90 text-[10px] sm:text-[12px] hover:bg-white text-black rounded-full w-5 sm:w-6 h-5 sm:h-6 flex items-center justify-center shadow-lg transition-all duration-200 hover:shadow-xl"
                onClick={(e) => {
                  e.stopPropagation();
                  handleResetZoom();
                }}
            ...
            {/* Close Button */}
            <button
              className="absolute top-1 sm:top-1 right-3 sm:right-5 z-20 bg-white/90 hover:bg-white text-black rounded-full w-5 sm:w-6 h-5 sm:h-6 flex items-center justify-center shadow-lg transition-all duration-200 hover:shadow-xl"
              onClick={closeModal}
              title="Close"
            >
              <svg
