        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-lg p-3 sm:p-4 md:p-6">
          ...
          >
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              ...
              <div>
                <p className="text-black font-medium leading-relaxed text-xs sm:text-sm">
            ...
            <div className="space-y-4 sm:space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  style={{ fontFamily: "Inter_18pt-regular" }}
                  className="w-full px-3 sm:px-4 py-2 sm:py-2.5 bg-gray-50 border border-gray-200 rounded-lg sm:rounded-xl focus:outline-none focus:ring-2 text-[10px] sm:text-[11px] lg:text-xs text-[#5D6079] focus:ring-primary-500 focus:border-transparent"
                  required
                />
              </div>
              ...
              <div>
                ...
                <div className="flex gap-1 sm:gap-2">
                  <select
                    ...
                    onChange={handleChange}
                    className="w-20 sm:w-[90px] md:w-[100px] px-1 sm:px-2 py-2 sm:py-2.5 bg-gray-50 border border-gray-200 rounded-lg sm:rounded-xl focus:outline-none focus:ring-2 text-[10px] sm:text-xs text-[#5D6079] focus:ring-primary-500 focus:border-transparent"
                    style={{ fontFamily: "Inter_18pt-regular" }}
                  >
                    {countries
                  ...
                  <input
                    ...
                    style={{ fontFamily: "Inter_18pt-regular" }}
                    className="flex-1 px-2 sm:px-4 py-2 sm:py-2.5 bg-gray-50 border border-gray-200 rounded-lg sm:rounded-xl focus:outline-none focus:ring-2 text-[10px] sm:text-[11px] lg:text-xs text-[#5D6079] focus:ring-primary-500 focus:border-transparent"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  style={{ fontFamily: "Inter_18pt-regular" }}
                  rows={5}
                  className="w-full px-3 sm:px-4 py-2 sm:py-2.5 bg-gray-50 border border-gray-200 rounded-lg sm:rounded-xl focus:outline-none focus:ring-2 text-[10px] sm:text-[11px] lg:text-xs text-[#5D6079] focus:ring-primary-500 focus:border-transparent resize-none"
                ></textarea>
              </div>
